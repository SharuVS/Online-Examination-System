...
Partial Class Page2
    ...
    Private Sub loadData(ByVal now As Integer)
        ...
        Dim tempPath As String = Server.MapPath("Qimage/img" & Val(lblqID.Text) & ".jpg")
        Dim imgInfo As New FileInfo(tempPath)

        Dim sourcePath As String = Server.MapPath("Qimage/")
        ...
        If obj.Length > 100 Then
            ...
            pic1.ImageUrl = "~/Qimage/img" & Val(lblqID.Text) & ".jpg"
            pic1.Visible = True
        Else
            pic1.ImageUrl = ""
            pic1.Visible = False
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Not IsPostBack) Then
            ...
            'Pic1.ImageUrl = "Img/banner1.jpg"
            'Pic1.ImageUrl = "img1.jpg"
            'Pic1.ImageUrl = Server.MapPath("img1.jpg")
            'get Paper Sub
            ...
            'Get Total No Of Que (Paper Setting)
            sett = sett.getAll()
            ...
            p.CreateQPaper(iTotQue, sPaper, s.ID)
            aListQPaper = p.getAll(iTotQue, sPaper, s.ID)
